...
--     vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#14171C" })
--     -- 		vim.api.nvim_set_hl(0, "FloatBorder", { fg = "#6E6A86", bg = "#14171C" })
--     vim.api.nvim_set_hl(0, "FloatBorder", { fg = "#6E6A86", bg = "NONE" })
--     vim.api.nvim_set_hl(0, "TelescopeNormal", { bg = "#14171C" })
--     vim.api.nvim_set_hl(0, "TelescopeBorder", { fg = "#6E6A86", bg = "#14171C" })
...
-- 		vim.api.nvim_set_hl(0, "Comment", { fg = "#5a636e" })
-- 		vim.api.nvim_set_hl(0, "SpecialComment", { fg = "#5a636e" })
-- 		vim.api.nvim_set_hl(0, "@comment", { fg = "#5a636e" })
