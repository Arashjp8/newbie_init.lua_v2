...
-- 			vim.api.nvim_set_hl(0, "@tag.builtin", { fg = "#89b4fa" })
-- 			vim.api.nvim_set_hl(0, "@tag.attribute.tsx", { fg = "#f9e2af" })
-- 			-- vim.api.nvim_set_hl(0, "TelescopeBorder", { fg = "none", bg = "none", bold = false })
-- 		end,
-- 	},
-- }
